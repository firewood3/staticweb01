...
(function ($) {
    ...
    var firstClassName = 'first paginate_button';
    ...
    $.fn.dataTableExt.oPagination.input = {
        'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
            ...
            nFirst.className = firstClassName + ' first-custom ' + classes.sPageButton;
            nPrevious.className = previousClassName + ' previous-custom ' + classes.sPageButton;
            nNext.className = nextClassName + ' next-custom ' + classes.sPageButton;
            nLast.className = lastClassName + ' last-custom ' + classes.sPageButton;

            nInput.className = paginateInputClassName + ' input-custom';
            nTotal.className = paginateTotalClassName + ' total-custom';
